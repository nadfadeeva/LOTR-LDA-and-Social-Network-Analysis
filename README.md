**Учебный проект "Тематическое моделирование и сетевой анализ текстов трилогии «Властелин колец» Дж.Р.Р.Толкина"**
=====================
...
* Метрика когерентности (Coherence Score: 0.53) и перплексия (-6.43) указывают на то, что модель успешно выделила интерпретируемые темы.
